...
const Footer = () => {
  return (
    <footer className="bg-[#23272a] p-[70px] text-white pb-[40px]">
      <div className="flex border-b-[1px] border-[#5865f2] pb-[30px] flex-wrap">
        <div className="flex mb-[50px] min-w-full">
          <h3 className="text-[#5865f2] text-[32px] font-extrabold w-6/12 leading-[1]">
            IMAGINE A PLACE
          </h3>

          <nav className="mt-[20px]">
            <ul className="flex">
              <li className="mr-[20px] text-[20px]">
                <a href="#">
      ...
      <div className="py-[30px] flex justify-between">
        <img src={discordLogo} />
        <Link to="/register">
          <div className="bg-[#5865f2] px-4 py-2 rounded-[40px] cursor-pointer text-[14px] hover:opacity-95">
            Open Discord
          </div>
        </Link>
      </div>
